            ...
            <div class="col-xl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="morris-donut-example" data-colors='["#f0f1f4","--bs-primary","--bs-info"]'
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <a href="layouts-horizontal.html#" class="btn btn-sm btn-primary">Load More</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <a href="layouts-horizontal.html#" class="text-primary">Learn more <i
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-centered table-vertical table-nowrap">
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('assets/images/users/user-3.jpg')}}" alt="user-image"
